    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        ...
        {isLoading && (
          <div className="absolute bottom-2 right-2 text-xs text-gray-400">
            <svg
              className="inline-block w-3 h-3 mr-1 animate-spin"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
      ...
      {/* Help Text */}
      <div className="text-xs text-gray-500 dark:text-gray-300 flex items-start gap-1 bg-white dark:bg-gray-900/50 p-2 rounded-lg border border-gray-200 dark:border-gray-700">
        <svg
          className="w-3 h-3 text-yellow-500 mt-0.5 flex-shrink-0"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
        ...
        <span>
          <strong>Tip:</strong> Remarks are required when rejecting. You can
          leave them empty when approving.
        </span>
      </div>

      {/* Dynamic Warning for Empty Remarks */}
      {!remarks.trim() && !isLoading && (
        <div className="text-xs text-amber-600 dark:text-amber-200 flex items-start gap-1 bg-amber-50 dark:bg-amber-900/20 p-2 rounded-lg border border-amber-200 dark:border-amber-600">
          <svg
