  ...
  return (
    <>
      ...
      >
        <div className="w-full">
          <div className="flex justify-between items-center h-14 px-4 sm:px-6 md:px-8">
            ...
            >
              <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg p-1.5 transform transition-transform group-hover:scale-105">
                <svg
              ...
              <span className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 dark:from-gray-100 dark:to-gray-300 bg-clip-text text-transparent">
                Attendly
              </span>
            </Link>
            ...
            <div className="flex items-center gap-2 sm:hidden">
              ...
              <button
                ...
                className="relative w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 active:bg-gray-300 dark:active:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 transition-all duration-200 flex items-center justify-center shadow-sm"
                aria-label={isMobileMenuOpen ? "Close menu" : "Open menu"}
                aria-expanded={isMobileMenuOpen}
              >
                <div className="w-5 h-5 flex flex-col justify-between items-center">
                  <span
                    className={`block w-full h-0.5 bg-current rounded-full transform transition-all duration-300 ease-in-out origin-center ${
      ...
      {isMobileMenuOpen && (
        <>
          <div
            className="fixed inset-0 bg-black/50 backdrop-blur-sm transition-all duration-300 z-40 sm:hidden"
            onClick={closeMobileMenu}
          />
          ...
          <div
            ref={mobileMenuRef}
            className="fixed top-0 right-0 h-full w-4/5 max-w-sm bg-white dark:bg-gray-900 shadow-2xl transition-transform duration-300 ease-in-out transform z-50 sm:hidden"
                ...
                {user ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 rounded-xl">
                      <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center shrink-0">
